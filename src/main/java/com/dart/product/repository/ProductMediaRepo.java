...
import com.dart.product.dto_model.product_media_model.MediaDbDTO;
...
@Repository
public interface ProductMediaRepo extends JpaRepository<MediaDbDTO, Long> {

    Optional<MediaDbDTO> findByProductIdAndOrganisationIdAndMediaTypeAndIsPrimary(Integer product_id, UUID organisation_id, String media_type, boolean is_primary);
